...
public final class ANombreRealtablevalue extends PRealtablevalue
{
    private TNombre _nombre_;

    public ANombreRealtablevalue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANombreRealtablevalue(
    ...
    {
        ((Analysis) sw).caseANombreRealtablevalue(this);
    }
