...
public final class AIdentifNparameters extends PNparameters
{
    private TIdentif _identif_;

    public AIdentifNparameters()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifNparameters(
    ...
    {
        ((Analysis) sw).caseAIdentifNparameters(this);
    }
