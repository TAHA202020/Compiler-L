...
public final class ANombreNparameters extends PNparameters
{
    private TNombre _nombre_;

    public ANombreNparameters()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseANombreNparameters(this);
    }
