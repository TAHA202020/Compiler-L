...
public final class ANombreSinglevalue extends PSinglevalue
{
    private TNombre _nombre_;

    public ANombreSinglevalue()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseANombreSinglevalue(this);
    }
