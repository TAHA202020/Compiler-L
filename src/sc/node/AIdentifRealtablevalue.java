...
public final class AIdentifRealtablevalue extends PRealtablevalue
{
    private TIdentif _identif_;

    public AIdentifRealtablevalue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifRealtablevalue(
    ...
    {
        ((Analysis) sw).caseAIdentifRealtablevalue(this);
    }
