...
public final class AIdentifSinglevalue extends PSinglevalue
{
    private TIdentif _identif_;

    public AIdentifSinglevalue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifSinglevalue(
    ...
    {
        ((Analysis) sw).caseAIdentifSinglevalue(this);
    }
