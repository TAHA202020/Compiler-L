...
public final class AFunctionFunctionglobalvar extends PFunctionglobalvar
{
    private PFunction _function_;

    public AFunctionFunctionglobalvar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionFunctionglobalvar(
    ...
    {
        ((Analysis) sw).caseAFunctionFunctionglobalvar(this);
    }
